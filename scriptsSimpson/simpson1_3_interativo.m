function [area]= simpson1_3_interativo(f)
  %{
  nessa função:
  ...
  A diferença deste arquivo para o outro se dá no fato de a,b e n não serem parâmetros na chamada da função, e sim em comandos de entrada
  %}

  
  a= input ("Digite o limite esquerdo: ");
  b= input ("Digite o limite direito: ");
  n= input ("Digite o número de segmentos criados: ");
